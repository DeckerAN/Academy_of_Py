...
## Option 2: Academy of Py (SELECTED)
...
* Create a high level snapshot (in table form) of the district's key metrics, including:
  ...
  * (x) % Passing Math
  * (x) % Passing Reading
  * (x) Overall Passing Rate (Average of the above two)
...
### Top Performing Schools (By Passing Rate) (x) 
...
### Bottom Performing Schools (By Passing Rate) (x) 

* Create a table that highlights the bottom 5 performing schools based on Overall Passing Rate. Include all of the same metrics as above.

### Math Scores by Grade\*\* (x) 

* Create a table that lists the average Math Score for students of each grade level (9th, 10th, 11th, 12th) at each school.

### Reading Scores by Grade (x)

* Create a table that lists the average Reading Score for students of each grade level (9th, 10th, 11th, 12th) at each school.

### Scores by School Spending (x) 
...
### Scores by School Size (x) 

* Repeat the above breakdown, but this time group schools based on a reasonable approximation of school size (Small, Medium, Large).

### Scores by School Type (x)
